...
COPY --from=registry.gitlab.com/lthn/build:wallet-lib-linux-libx / /
COPY --from=registry.gitlab.com/lthn/build:wallet-lib-linux-boost / /
COPY --from=registry.gitlab.com/lthn/build:wallet-lib-linux-cmake / /
COPY --from=registry.gitlab.com/lthn/build:wallet-lib-linux-fontconfig / /
COPY --from=registry.gitlab.com/lthn/build:wallet-lib-linux-utils / /
